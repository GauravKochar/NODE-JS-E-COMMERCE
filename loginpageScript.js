...
loginbtn.addEventListener("click",function(event)
{
	...
	if(loginas.value=="Admin")
	{
		if(usertext.value=="gaurav123"&&userpass.value=="kochar123")
		{
			...
			window.location.href="file:///C:/Users/Gaurav/Desktop/My%20javascriptproject/NODE%20E-commerce%20Project/dashboardInNodehtml.html";
		}
		/*else	
		{
							...
							for( i=0;i<responsetxt1.length;i++)
							{
									...
									if(status==1)
									{
										getSessionuser(function(stat)
										{
											...
											window.location.href="file:///C:/Users/Gaurav/Desktop/My%20javascriptproject/NODE%20E-commerce%20Project/userdahshboardhtmlNODE.html";
											}
											else
