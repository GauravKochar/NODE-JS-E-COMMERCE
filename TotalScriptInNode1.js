		...
		var cartproducts;
			postHeader(headerobj,function()
			{
				...
				getrequest(function(cartproduct)
				{
					...
					makedetailobject(cartproducts,function()
					{
...
function senddetailobject(detailobj,callback)
{
							var xmlhttp3=new XMLHttpRequest();
...
{
	var i;
	for( i=0;i<cartproducts.length;)
		{
								
								giveodid(i,function(i,odid)
								{
									console.log(odid,"i here" +i);
									var detailobj=new makedetailobj(cartproducts[i],orderid,odid);
									senddetailobject(detailobj,function()
									{
